    ...
    <Layout>
      <div className="min-h-screen pt-16">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold mb-8 text-ecru">Syarat dan Ketentuan</h1>
          
          <div className="prose prose-lg prose-invert max-w-none">
            <p className="text-lavender-web opacity-80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-lavender-web">1. Ketentuan Umum</h2>
            <p className="text-lavender-web opacity-80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-lavender-web">2. Penggunaan Layanan</h2>
            <p className="text-lavender-web opacity-80">
            ...
            <ul className="list-disc pl-6 text-lavender-web opacity-80 space-y-2">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-lavender-web">3. Akun Pengguna</h2>
            <p className="text-lavender-web opacity-80">
            ...
            <p className="text-lavender-web opacity-80 mt-4">
              Anda harus segera memberi tahu kami tentang penggunaan tidak sah akun Anda atau pelanggaran keamanan lainnya.
            </p>

            <h2 className="text-2xl font-semibold mt-8 mb-4 text-lavender-web">4. Konten Pengguna</h2>
            <p className="text-lavender-web opacity-80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-lavender-web">5. Privasi</h2>
            <p className="text-lavender-web opacity-80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-lavender-web">6. Perubahan pada Syarat dan Ketentuan</h2>
            <p className="text-lavender-web opacity-80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-lavender-web">7. Penghentian</h2>
            <p className="text-lavender-web opacity-80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-lavender-web">8. Batasan Tanggung Jawab</h2>
            <p className="text-lavender-web opacity-80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-lavender-web">9. Hukum yang Berlaku</h2>
            <p className="text-lavender-web opacity-80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-lavender-web">10. Kontak</h2>
            <p className="text-lavender-web opacity-80">
              Jika Anda memiliki pertanyaan tentang syarat dan ketentuan ini, silakan hubungi kami di:
            </p>
            <p className="text-ecru font-medium">info@grabals.com</p>

            <div className="mt-12 p-6 bg-raisin-black/50 border border-eggplant/30 rounded-lg">
              <p className="text-lavender-web opacity-80 text-center">
